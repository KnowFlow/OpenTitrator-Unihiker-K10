...
def upload(ip: str, bin_path: str, password: str) -> bool:
    url = f"http://{ip}/ota"
...
def main():
    ...
    parser.add_argument("--password", required=True, help="Controller administrator password")
    args = parser.parse_args()

    if not upload(args.ip, args.bin, args.password):
        sys.exit(1)
